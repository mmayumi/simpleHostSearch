...
public class EntityUtil {
    ...
    private final String bean_path = "D:\\develop\\nzySpace2\\search\\src\\main\\java";

    private final String mapper_path = "D:\\develop\\nzySpace2\\search\\src\\main\\java\\com\\nn\\search\\dao";

    private final String xml_path = "D:\\develop\\nzySpace2\\search\\src\\main\\resources\\mapping";// xml路径

    private final String model_package = "com.nn.search.domain";// model的包所在

    private final String dao_package = "com.nn.search.dao";// dao的包所在
    ...
    private final String url = "jdbc:mysql://localhost:3306/" + moduleName + "?3useUnicode=true"
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        bw.newLine();
        bw.write("import com.nn.first.utils.bean.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
